...
class TestingNumerics(unittest.TestCase):
    ...
    def test_affix(self):
        ...
        self.assertAlmostEqual(c.value, f.value, delta=0.11 * c.value)
    ...
    def test_doubleaffix(self):
        ...
        f = c.roll()
        b.seal(True)
        self.assertAlmostEqual(c.value[0], f.value[0], delta=0.11 * c.value[0])
        self.assertAlmostEqual(c.value[1], f.value[1], delta=0.11 * c.value[1])
        self.assertIsNotNone(f.describe())
        self.assertIsNotNone(a.describe())
        self.assertIsNotNone(b.describe())
        self.assertIsNotNone(h.describe())
