...
class TestingNumerics(unittest.TestCase):
    ...
    def test_affix(self):
        ...
        d = Affix("test", 10, [Flags.INT], 0.5, 1.5)
    ...
    def test_damage(self):
        ...
        d.ignore_block = True
        d.ignore_dodge = True
        self.assertEqual(type(d.describe(c)), str)
    ...
    def test_stat(self):
        ...
        af4 = Affliction("d", 1, 0, [Flags.FLAT], stackable=True)
        a.afflict(af1)
        a.afflict(af2)
        a.afflict(af3)
    ...
    def test_ressources(self):
        ...
        self.assertEqual(len(a.gather_afflictions()), 0)
        self.assertEqual(type(a.describe()), tuple)
        self.assertEqual(type(a.describe(True)), tuple)
