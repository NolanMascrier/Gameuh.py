...
def load_images():
    ...
    SYSTEM["images"]["inferno"] = Image("icons/temp/FireMage_15.png").scale(64, 64)
    SYSTEM["images"]["ice_mastery"] = Image("icons/temp/FrostMage_25.png").scale(64, 64)
    SYSTEM["images"]["congelation"] = Image("icons/temp/FrostMage_8.png").scale(64, 64)
    SYSTEM["images"]["icebolt"] = Image("icons/temp/FrostMage_14.png").scale(64, 64)
    SYSTEM["images"]["cone_of_flames"] = Image("icons/temp/FireMage_17.png").scale(64, 64)
    ...
    SYSTEM["images"]["tree_start"] = Image("icons/temp/BloodMage_3.png").scale(64, 64)
