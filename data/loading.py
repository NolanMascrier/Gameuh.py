...
def load_images():
    ...
    SYSTEM["images"]["fire_mastery"] = Image("icons/spells/FireMage_5.png").scale(64, 64)
    ...
    SYSTEM["images"]["icebolt"] = Image("icons/spells/FrostMage_14.png").scale(64, 64)
    ...
    SYSTEM["images"]["call_lightning"] = Image("icons/spells/call_lightning.png").scale(64, 64)
    SYSTEM["images"]["rising_tempest"] = Image("icons/spells/rising_tempest.png").scale(64, 64)
    SYSTEM["images"]["ride_the_storm"] = Image("icons/spells/ride_the_storm.png").scale(64, 64)
    SYSTEM["images"]["lightning_fork"] = Image("icons/spells/lightning_fork.png").scale(64, 64)
    SYSTEM["images"]["ice_orb"] = Image("icons/spells/ice_orb.png").scale(64, 64)
    SYSTEM["images"]["ice_wall"] = Image("icons/spells/ice_wall.png").scale(64, 64)
    SYSTEM["images"]["ice_spear"] = Image("icons/spells/ice_spear.png").scale(64, 64)
