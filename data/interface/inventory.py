...
def draw_inventory(events):
    ...
    for event in events:
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            SYSTEM["images"]["button_sort_name"].press(event.pos)
            SYSTEM["images"]["button_sort_rarity"].press(event.pos)
            SYSTEM["images"]["button_sort_value"].press(event.pos)
            SYSTEM["images"]["button_sort_date"].press(event.pos)
