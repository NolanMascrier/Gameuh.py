...
MODIFIERS = {
    ...
    "damage": ([
        (Affix("AREA_DMG_1", 0.1, [Flags.BOON, Flags.ALL_DAMAGE],
                level_modifier=True), 1, 0, 60),
        (Affix("AREA_DMG_2", 0.3, [Flags.BOON, Flags.ALL_DAMAGE],
                level_modifier=True), 0.8, 0, 60),
        (Affix("AREA_DMG_3", 0.5, [Flags.BOON, Flags.ALL_DAMAGE],
                level_modifier=True), 0.6, 10, 80),
        (Affix("AREA_DMG_4", 0.7, [Flags.BOON, Flags.ALL_DAMAGE],
                level_modifier=True), 0.5, 10, 80),
        (Affix("AREA_DMG_5", 1.1, [Flags.BOON, Flags.ALL_DAMAGE],
                level_modifier=True), 0.4, 20, 90),
        (Affix("AREA_DMG_6", 1.5, [Flags.BOON, Flags.ALL_DAMAGE],
                level_modifier=True), 0.4, 25, 999),
        (Affix("AREA_DMG_7", 2, [Flags.BOON, Flags.ALL_DAMAGE],
                level_modifier=True), 0.3, 40, 999),
    ], 0.7, 1.2),
    "res": ([
        (Affix("AREA_RES_1", 0.02, [Flags.BOON, Flags.ALL_RESISTANCES],
                level_modifier=True), 1, 0, 60),
        (Affix("AREA_RES_2", 0.1, [Flags.BOON, Flags.ALL_RESISTANCES],
                level_modifier=True), 0.8, 0, 60),
        (Affix("AREA_RES_3", 0.15, [Flags.BOON, Flags.ALL_RESISTANCES],
                level_modifier=True), 0.6, 10, 80),
        (Affix("AREA_RES_4", 0.2, [Flags.BOON, Flags.ALL_RESISTANCES],
                level_modifier=True), 0.5, 10, 80),
        (Affix("AREA_RES_5", 0.3, [Flags.BOON, Flags.ALL_RESISTANCES],
                level_modifier=True), 0.4, 20, 90),
        (Affix("AREA_RES_6", 0.4, [Flags.BOON, Flags.ALL_RESISTANCES],
                level_modifier=True), 0.4, 25, 999),
        (Affix("AREA_RES_7", 0.6, [Flags.BOON, Flags.ALL_RESISTANCES],
                level_modifier=True), 0.3, 40, 999),
    ], 0.2, 2.2),
    "dodge": ([
    ...
    "cast_speed": ([
        ...
        (Affix("AREA_CSPEED_6", 1.5, [Flags.BOON, Flags.CSPEED],
               level_modifier=True), 0.4, 25, 999),
